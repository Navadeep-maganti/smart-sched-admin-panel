...
export const StudentsPage = () => {
  ...
  // "student_id":1,"roll_no":"424151","student_name":"Navadeep Maganti","email":"madhu@gmail.com","role":"STUDENT","department_id":3,"department_code":"PERF-CSE","department_name":"Performance Computer Science"
  const columns: ColumnDef<any>[] = [
    { header: 'Roll Number', accessorKey: 'roll_no' },
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-soft">
        ...
        <DataTable columns={columns} data={data} emptyText="No students found." />
      </div>
    </div>
  );
};